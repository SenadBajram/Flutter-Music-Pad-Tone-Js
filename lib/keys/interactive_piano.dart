...
typedef OnNotePositionTappedUp = void Function(NotePosition position);
...
class InteractivePiano extends StatefulWidget {
  ...
  final OnNotePositionTappedUp? onNotePositionTappedUp;
...
class _InteractivePianoState extends State<InteractivePiano> {
  ...
  void Function()? _onNoteTappedUp(NotePosition notePosition) =>
      widget.onNotePositionTappedUp == null
          ? null
          : () => widget.onNotePositionTappedUp!(notePosition);
}
